...
<body>
    ...
    <x-preloader />
    <!-- ===== Preloader End ===== -->
    <div class=" boxcar-wrapper bg-home">
        <!-- blog-section-two -->
        <section>
            <div class="boxcar-container">
                    ...
                    <div class="blog-blockt-two col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box two wow fadeInUp animated" data-wow-delay="100ms"
                            ...
                            <div class="hover-img">
                                ...
                                <svg height="100px" width="100px" version="1.1" id="Capa_1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    viewBox="0 0 16.521 16.521" xml:space="preserve">
                                    <g>
                                        <g>
                                            <path style="fill:#030104;"
                                                d="M16.253,7.184c-0.375-0.125-1.571-0.152-3.13-0.124l0.072,0.072
                ...
                c-0.009-0.006-0.018-0.018-0.027-0.025h2.374c-0.012,0.012-0.024,0.025-0.035,0.035C12.592,10.384,12.173,10.489,11.683,10.489z">
                                            ...
                                            <path style="fill:#030104;" d="M4.426,5.424C5.247,5.352,5.488,7.137,5.21,7.601l5.301-0.213c0.029,0.002,1.654-0.104,2.396-0.725
                ...
                h0.423L7.497,6.365H6.352C6.238,5.399,7.302,5.5,7.302,5.5z"></path>
                                            <path style="fill:#030104;" d="M15.041,12.118l-0.068,0.008c-0.075,0.014-0.208,0.027-0.359,0.027
