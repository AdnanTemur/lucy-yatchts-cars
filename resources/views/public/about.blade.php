                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="content-box">
                            <div class="text">Lorem ipsum dolor sit amet consectetur. Convallis integer enim eget sit
                                urna. Eu duis lectus amet vestibulum varius. Nibh tellus sit sit at lorem facilisis. Nunc
                                vulputate ac interdum aliquet
                            ...
                            <div class="text">Sit convallis rhoncus dolor purus amet orci urna. Lobortis vulputate
                                ...
                                ipsum. Sit est nunc pellentesque at a aliquam ultrices consequat. Velit duis velit nec amet
                                eget
                ...
                <div class="row">
                    <div class="exp-block col-md-2 col-sm-12">
                        <div class="inner-box">
                            ...
                            <div class="image-box">
                                <figure class="image"><img src="images/resource/about-inner1-1.jpg" alt="">
                                </figure>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="image-block col-md-5 col-sm-12">
                        ...
                        <div class="row box-double-img">
                            <div class="image-block col-lg-5 col-5">
                                <div class="image-box">
                                    <figure class="image"><img src="images/resource/about-inner1-4.jpg" alt="">
                                    </figure>
                                </div>
                            </div>
                            <div class="image-block col-lg-7 col-7">
                                <div class="image-box">
                                    <figure class="image"><img src="images/resource/about-inner1-5.jpg" alt="">
                                    </figure>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="image-column col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-column">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img src="images/resource/pricing1-1.jpg"
                                            alt=""></a></figure>
                                <a href="https://creativelayers.net/watch.html?v=Fvae8nxzVz4" class="play-now"
                                    data-fancybox="gallery" data-caption=""><i class="fa fa-play"
                    ...
                    <div class="content-column col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-column">
                            ...
                            <ul class="list-style-one wow fadeInUp" data-wow-delay="100ms">
                                <li><i class="fa-solid fa-check"></i>We are the UK’s largest provider, with more patrols in
                                    more places</li>
                            ...
                            <a href="#" class="read-more wow fadeInUp" data-wow-delay="200ms">get started<svg
        ...
        <div class="boxcar-brand-section">
            <div class="boxcar-container">
                <div class="boxcar-title">
                    ...
                    <a href="{{route('cars-list')}}" class="btn-title">Show All Brands<svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="row">
                    ...
                    <div class="cars-block col-lg-2 col-md-6 col-sm-6">
                        <div class="inner-box wow fadeInUp">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img src="images/resource/brand-1.png"
                                            alt=""></a></figure>
                            </div>
                            <div class="content-box">
                    ...
                    <div class="cars-block col-lg-2 col-md-6 col-sm-6">
                        <div class="inner-box wow fadeInUp" data-wow-delay="100ms">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img src="images/resource/brand-2.png"
                                            alt=""></a></figure>
                            </div>
                            <div class="content-box">
                    ...
                    <div class="cars-block col-lg-2 col-md-6 col-sm-6">
                        <div class="inner-box wow fadeInUp" data-wow-delay="200ms">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img src="images/resource/brand-3.png"
                                            alt=""></a></figure>
                            </div>
                            <div class="content-box">
                    ...
                    <div class="cars-block col-lg-2 col-md-6 col-sm-6">
                        <div class="inner-box wow fadeInUp" data-wow-delay="300ms">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img src="images/resource/brand-4.png"
                                            alt=""></a></figure>
                            </div>
                            <div class="content-box">
                    ...
                    <div class="cars-block col-lg-2 col-md-6 col-sm-6">
                        <div class="inner-box wow fadeInUp" data-wow-delay="400ms">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img src="images/resource/brand-5.png"
                                            alt=""></a></figure>
                            </div>
                            <div class="content-box">
                    ...
                    <div class="cars-block col-lg-2 col-md-6 col-sm-6">
                        <div class="inner-box wow fadeInUp" data-wow-delay="500ms">
                            <div class="image-box">
                                <figure class="image"><a href="#"><img src="images/resource/brand-6.png"
                                            alt=""></a></figure>
                            </div>
                            <div class="content-box">
                ...
                <div class="right-box">
                    ...
                    <div class="row stories-slider">
                        ...
                        <div class="testimonial-block-four col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <figure class="icon"><a href="#"><img src="images/resource/comas.png"
                                            alt=""></a></figure>
                                ...
                                <div class="auther-info">
                                    <figure class="image"><a href="#"><img src="images/resource/test-auther-1.jpg"
                                                alt=""></a></figure>
                        ...
                        <div class="testimonial-block-four col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                ...
                                <div class="text"> “Amazing design, easy to customize and a design quality
                                    ...
                                    the optimized performance. And we didn’t on our original designs.”</div>
                                <div class="auther-info">
                                    <figure class="image"><a href="#"><img src="images/resource/test-auther-2.jpg"
                                                alt=""></a></figure>
                        ...
                        <div class="testimonial-block-four col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                ...
                                <div class="text"> “Amazing design, easy to customize and a design quality
                                    ...
                                    the optimized performance. And we didn’t on our original designs.”</div>
                                <div class="auther-info">
                                    <figure class="image"><a href="#"><img src="images/resource/test-auther-3.jpg"
                                                alt=""></a></figure>
                    ...
                    <div class="inner-column">
                        ...
                        <ul class="widget-accordion wow fadeInUp">
                            ...
                            <li class="accordion block active-block">
                                <div class="acc-btn active">Does BoxCar own the cars I see online or are they owned by
                                    other.<div class="icon fa fa-plus"></div>
                                </div>
                                <div class="acc-content current">
                                    <div class="content">
                                        <div class="text">Cras vitae ac nunc orci. Purus amet tortor non at phasellus
                                            ultricies hendrerit.
                                            Eget a, sit morbi nunc sit id massa. Metus, scelerisque volutpat nec sit vel
                                            donec. Sagittis,
                            ...
                            <li class="accordion block">
                                <div class="acc-btn">How do you choose the cars that you sell?<div
                                        class="icon fa fa-plus"></div>
                                </div>
                            ...
                            <!--Block-->
                            <li class="accordion block">
                                <div class="acc-btn">Can I save my favorite cars to a list I can view later?<div
                                        class="icon fa fa-plus"></div>
                                </div>
                                <div class="acc-content">
                                    <div class="content">
                            ...
                            <!--Block-->
                            <li class="accordion block">
                                <div class="acc-btn">Can I be notified when cars I like are added to your inventory?<div
                                        class="icon fa fa-plus"></div>
                                </div>
                                <div class="acc-content">
                                    <div class="content">
                            ...
                            <!--Block-->
                            <li class="accordion block">
                                <div class="acc-btn">What tools do you have to help me find the right car for me and my
                                    budget?<div class="icon fa fa-plus"></div>
                                </div>
                                <div class="acc-content">
                                    <div class="content">
                                        <div class="text">Cras vitae ac nunc orci. Purus amet tortor non at phasellus
