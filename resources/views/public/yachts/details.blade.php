...
@section('content')
 <!-- inventory-section -->
 <section class="inventory-section v1 pb-0 layout-radius mt-5">
                ...
                <div class="inner-column">
                    ...
                    <div class="features-sec v2">
                        ...
                        <div class="row">
                            ...
                            <span>Service Guarantee by Bookanyboat.com, created for your peace of mind. If you see this badge on any boat listing, we guarantee the following expectations:</span>
                                ...
                                <div class="inner-column">
                                    <ul class="widget-accordion wow fadeInUp">
                                        ...
                                        <li class="accordion block active-block">
                                            <div class="acc-btn active">Complimentary Inclusions<div class="icon fa fa-angle-down"></div></div>
                                        ...
                                        <li class="accordion block">
                                            <div class="acc-btn">Connectivity<div class="icon fa fa-angle-down"></div></div>
                                        ...
                                        <li class="accordion block v2">
                                            <div class="acc-btn">Navigation and Safety<div class="icon fa fa-angle-down"></div></div>
                                            <div class="acc-content">
                                                <div class="content">
                                                    <div class="row">
                                                        <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <li class="accordion block v2">
                                            <div class="acc-btn">Saloon & Cabin Facilities<div class="icon fa fa-angle-down"></div></div>
                                            <div class="acc-content">
                                                <div class="content">
                                                    <div class="row">
                                                        <div class="list-column col-lg-6 col-md-6 col-sm-12">
                                                            <div class="inner-column">
                                                                <ul class="spects-list">
                                                                    ...
                                                                    <li><span>	✔️Sink</span>	✔️Dinnerware & Cups (Plastic)
                                        ...
                                        <li class="accordion block v2">
                                            <div class="acc-btn">Entertainment<div class="icon fa fa-angle-down"></div></div>
                                            <div class="acc-content">
                                                <div class="content">
                                                    <div class="row">
                                                        <div class="list-column col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="inner-column">
                    <div class="contact-box-two v2">
                     ...
                     <div class="overview-box">
                        ...
                        <ul class="list v2">
                            <li><span><img src="images/resource/insep1-1.svg">Year of Manufacure</span>2009</li>
                            <li><span><img src="images/resource/insep1-2.svg">Length</span>76ft/23m</li>
                            <li><span><img src="images/resource/insep1-3.svg">Engine</span>2x0hp</li>
                            <li><span><img src="images/resource/insep1-4.svg">Fuel Tank</span>2023</li>
                            <li><span><img src="images/resource/insep1-5.svg">Captain & Crew</span>Included</li>
                            <li><span><img src="images/resource/insep1-6.svg">Guests Capacity</span>35</li>
                            <li><span><img src="images/resource/insep1-7.svg">Sleeps</span>-</li>
                            <li><span><img src="images/resource/insep1-8.svg">Bathroom/Toilets</span>3</li>
                        </ul>
                    </div>
            ...
            <div class="row car-slider-three" data-preview="4">
                ...
                <div class="box-car car-block-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="content-box">
                            <h6 class="title"><a href="inventory-page-single-v2.html">SKYRA - 76ft/23M - <br> Yacht</a>
                            </h6>
                            <ul>
                ...
                <div class="box-car car-block-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="content-box">
                            <h6 class="title"><a href="inventory-page-single-v2.html">Gold Yacht - 90ft/27m <br> Yacht</a>
                            </h6>
                            <ul>
                ...
                <div class="box-car car-block-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="content-box">
                            <h6 class="title"><a href="inventory-page-single-v2.html">135ft MAZAYEL - 135ft/41m - Yacht</a>
                            </h6>
                            <ul>
                                <li><i class="flaticon-user"></i>190 Guests</li>
                                <li><i class="flaticon-speedometer"></i>90ft/27m</li>
                ...
                <div class="box-car car-block-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="content-box">
                            <h6 class="title"><a href="inventory-page-single-v2.html">Sunseeker 90ft - 90ft/27m (2018) - Yacht</a>
                            </h6>
                            <ul>
